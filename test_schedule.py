...
from scan_schedule import next_events, slot_key, already_processed, CRON
...
class ScheduleTests(unittest.TestCase):
    ...
    def test_market_hours_half_hour(self):
        self.assertEqual(self.next_scan('2026-09-14T09:00').isoformat(), '2026-09-14T09:37:00-04:00')
        self.assertEqual(self.next_scan('2026-09-14T09:38').isoformat(), '2026-09-14T10:07:00-04:00')
        self.assertEqual(self.next_scan('2026-09-14T10:08').minute, 37)
    ...
    def test_early_close_and_settlement(self):
        ...
        self.assertEqual(events['settlement'].astimezone(NY).isoformat(), '2026-11-27T13:37:00-05:00')
    ...
    def test_idempotency_slots_preserve_previous_frequency(self):
        a = slot_key(datetime(2026,9,14,10,7,tzinfo=NY))
        b = slot_key(datetime(2026,9,14,10,37,tzinfo=NY))
        self.assertNotEqual(a, b)
        self.assertEqual(b, slot_key(datetime(2026,9,14,10,59,tzinfo=NY)))
        self.assertEqual(a, '2026-09-14T10:00')
        self.assertTrue(already_processed('2026-09-14T10:15', datetime(2026,9,14,10,22,tzinfo=NY)))
        self.assertFalse(already_processed('2026-09-14T10:15', datetime(2026,9,14,10,37,tzinfo=NY)))
